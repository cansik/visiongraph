...
class GraphNode(Processable[InputType, OutputType], ArgumentConfigurable, ABC):
    ...
    def process(self, data: InputType) -> OutputType:
        ...
        Args:
            data (InputType): The input data to be processed by the node.

        Returns:
            OutputType: The output data generated by processing the input.
        """
    ...
    def configure_and_setup(self, args: Namespace) -> None:
        ...
        Args:
            args (Namespace): The configuration arguments to be applied to the node.
        """
        self.configure(args)
        self.setup()
