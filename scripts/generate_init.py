...
class GenerateInitPy(distutils.cmd.Command):
    ...
    def run(self) -> None:
        ...
        excluded_modules = {"visiongraph.external"}
        late_import_modules = {
        ...
        analyzer = ModuleAnalyzer(
            ...
            late_import_modules=late_import_modules,
            optional_modules=optional_modules,
            module_with_methods=module_with_methods
        )
        ...
        with open(f"{root_package}/vg/__init__.py", "w+") as file:
            file.write("\n".join(lines))
